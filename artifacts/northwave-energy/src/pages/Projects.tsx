...
const VIDEOS = [
  { id: "P-OkruGPco4", title: "Offshore Drilling Operations", desc: "Deep sea rig mobilization and platform setup" },
  { id: "Vcl1PLxjl2s", title: "Subsea Pipeline Installation", desc: "SURF installation in extreme-depth conditions" },
  { id: "PCGeQdZpO6A", title: "Heavy Lift and Deck Operations", desc: "Crane operations and cargo handling aboard an offshore production facility" },
];
